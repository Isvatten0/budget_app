-- Extended Database Schema for Budget Planner App
-- This includes new tables for income tracking, credit cards, and bill payments
...
-- New table for one-time income entries
...
-- Enhanced recurring expenses with payment tracking
...
-- New table for credit card payments
...
-- New table for goal contributions
